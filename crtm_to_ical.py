...
parser = argparse.ArgumentParser(
    description='Crea un calendario con la información del la tarjeta de transporte')
...
def get_info(tarjeta):
    r = requests.get(
        "https://www.tarjetatransportepublico.es/CRTM-ABONOS/consultaSaldo.aspx")
    ...
    r = requests.post(
        "https://www.tarjetatransportepublico.es/CRTM-ABONOS/consultaSaldo.aspx", data=data)
    soup = bs4.BeautifulSoup(r.text, "lxml")
